<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="依据类型" prop="type" align="center" min-width="130px" />
      <el-table-column label="依据备注" prop="remark" align="left" min-width="130px" />
      <el-table-column label="依据内容" prop="basis" align="left" min-width="300px" />
    </el-table>
    <!-- 记录条数 分页-->
    <pagination
      :total="total"
...
import { busDiagBasis } from '@/api/columnBtn'
...
export default {
  ...
  methods: {
    getList() {
      ...
      busDiagBasis(this.DiagnoseTable).then(response => {
