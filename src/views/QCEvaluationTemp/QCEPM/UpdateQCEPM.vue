<template>
  <div class="container">
    <div class="top-container">
      <div class="content-title">修改质控评价项目</div>
      <hr>
    </div>
...
export default {
  ...
  data() {
    return {
      QcForm: {
        qcItemCode: this.$route.query.qcItemCode, // 序号
        qcItemName: this.$route.query.qcItemName,
        qcItemGoodDesc: this.$route.query.qcItemGoodDesc,
        qcItemBadDesc: this.$route.query.qcItemBadDesc,
        qcItemImproveDesc: this.$route.query.qcItemImproveDesc,
        qcItemType: this.$route.query.qcItemType
      },
      list: [],
      items: [],
      typeOptions,
