      ...
      <div class="scoll" :style="conheight">
        <el-scrollbar style="height:100%">
          ...
          >
            ...
            <el-form-item v-if="RoleMgForm.ownsAllRight != true" label="显示所有模块:">
              <el-checkbox v-model="RoleMgForm.showAllMoudle" style="width:52%;float:right" />
            </el-form-item>
            <el-form-item v-if="RoleMgForm.ownsAllRight != true">
              <el-tree
                ref="tree"
                :data="treeData"
                show-checkbox
            ...
            <el-form-item class="bottom-btn">
              <el-button type="primary" @click="save('RoleMgForm')">保存</el-button>
  ...
  data() {
    return {
      RoleMgForm: {
        ...
        ownsAllRight: this.$route.query.ownsAllRight,
        showAllMoudle: this.$route.query.showAllMoudle,
        moudleIds: []
      },
      treeData: [],
      defaultProps: {
